...
class FeatureExtractor:
    def __init__(
        self, feat_options: Optional[FeatureExtractorOptions] = None, **kwargs
    ):
        if feat_options is None:
            feat_options = FeatureExtractorOptions(**kwargs)
        n_fft, hop_length = feat_options.n_fft, feat_options.hop_length
        chunk_length = feat_options.chunk_length
        sampling_rate = feat_options.sampling_rate
        feature_size = feat_options.feature_size
